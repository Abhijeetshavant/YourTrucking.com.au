  ...
  const videos = [
    {
      ...
      icon: Ship,
      stats: { label: "Containers Moved", value: "500+" },
    ...
    },
    {
      ...
      icon: Building2,
      stats: { label: "Councils Served", value: "15+" },
    ...
    },
    {
      ...
      icon: Truck,
      stats: { label: "Active Vehicles", value: "20+" },
    ...
    },
    {
      ...
      icon: Warehouse,
      stats: { label: "Warehouse Space", value: "500 sqm" },
    ...
    },
    {
      ...
      icon: Warehouse,
      stats: { label: "Daily Loads", value: "100+" },
